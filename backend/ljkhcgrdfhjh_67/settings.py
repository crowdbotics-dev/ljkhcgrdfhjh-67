"""
Django settings for ljkhcgrdfhjh_67 project.
...
ROOT_URLCONF = 'ljkhcgrdfhjh_67.urls'
...
WSGI_APPLICATION = 'ljkhcgrdfhjh_67.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "ljkhcgrdfhjh Support <support@ljkhcgrdfhjh-67.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ljkhcgrdfhjh_67 API",
    "DESCRIPTION": "API documentation for ljkhcgrdfhjh_67 App",
    "VERSION": "v1",
}
